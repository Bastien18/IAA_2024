...
const char * V_SREVISION="e1df91b4a1ea";
const char * V_STAG="2023.02 +1";
const char * V_BRANCH="heads/2023.11";
const bool V_MODIFIED=true;
const bool V_PRODUCTION_RELEASE=false;

/* Version recoverable from the ground */
const uint32_t V_REVISION_0=0xe1df91b4;
const uint16_t V_REVISION_1=0xa1ea;
